...
public class KiviGame extends JFrame {
    ...
    public KiviGame() {
        ...
        // Single Settings button (replacing separate player and display settings
        // buttons)
    ...
    // Custom panel for drawing bobbleheads - made public to be accessible from
    // PlayerSettings
    public static class BobbleheadPanel extends JPanel implements PlayerSettings.BobbleheadPanel {
        ...
        protected void paintComponent(Graphics g) {
            ...
            if (isCpu) {
                ...
                g2d.fillOval(headX + headDiameter / 3 - pupilSize / 2, headY + headDiameter / 3 + eyeSize / 4,
                        pupilSize, pupilSize);
                g2d.fillOval(headX + 2 * headDiameter / 3 - pupilSize / 2, headY + headDiameter / 3 + eyeSize / 4,
                        pupilSize, pupilSize);
